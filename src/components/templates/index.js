...
const Theme = () => {
  return (
    <div className="App">
        ...
        style={{backgroundImage: "url('images/cover_bg_3.jpg')", height: "789px", backgroundPosition: "0px 0px"}} data-stellar-background-ratio="0.5">
        ...
        <div id="fh5co-footer">
            <div className="container">
                <div className="row">
                    <div className="col-md-12">
                        <p>&copy; 2022 All Rights Reserved. <br/>Designed by Saurav</p>
                    </div>
                </div>
            </div>
        </div>
